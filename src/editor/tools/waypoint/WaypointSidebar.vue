...
import WaypointCopyModal from '../../commands/waypoint/WaypointCopyModal.vue'
import WaypointClearModal from '../../commands/waypoint/WaypointClearModal.vue'
...
const waypoints = computed(() => [...getStoreEntities(store.value.grid.waypoint)].sort((a, b) => a.beat - b.beat))
...
<template>
    <BaseSidebar :title="i18n.waypoint.title">
